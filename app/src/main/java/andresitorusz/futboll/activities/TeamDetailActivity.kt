...
import andresitorusz.futboll.fragments.OverviewFragment
import andresitorusz.futboll.fragments.PlayerFragment
...
class TeamDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        page = mutableMapOf(OverviewFragment.newInstance(teamDescription) to getString(R.string.overview), PlayerFragment.newInstance(teamId) to getString(
                    R.string.players))
