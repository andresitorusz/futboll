 ...
 */
class LastEventFragment : Fragment(), EventContract.View {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycler_view_last.layoutManager = LinearLayoutManager(context)
        recycler_view_last.adapter = adapter
    ...
    override fun showLoading() {
        ...
        recycler_view_last.invisible()
        empty_last_event.invisible()
    }

    override fun hideLoading() {
        progress_bar_last.invisible()
        recycler_view_last.visible()
        empty_last_event.invisible()
    }
    ...
    override fun showLeagues(data: List<League>?) {
        ...
        last_event_spinner.adapter = spinnerAdapter
        last_event_spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                val leagueName: League = last_event_spinner.selectedItem as League
